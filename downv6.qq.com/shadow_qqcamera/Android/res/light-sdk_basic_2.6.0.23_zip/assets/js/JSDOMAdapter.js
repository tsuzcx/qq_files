...
// 加载webgl的一些常量
(function () {
    if (lightCanvas.CanvasContextWebGLWrapper.prototype == undefined) {
        lightCanvas.CanvasContextWebGLWrapper.prototype = new lightCanvas.CanvasContextWebGLWrapper();
    }
}());
...
// });
    ...
    lightCanvas.HTMLCanvasElement.prototype.addEventListener = window.addEventListener = function (type, callback, useCapture) {
       window.document.addEventListener(type, callback, useCapture);
    };
    lightCanvas.HTMLCanvasElement.prototype.removeEventListener = window.removeEventListener = function (type, callback) {
...
// The native Image, Audio, HttpRequest and LocalStorage class mimic the real elements
    window.Image = lightCanvas.HTMLImageElement;
    this.Image = lightCanvas.HTMLImageElement;
    ...
    window.document = {
        ...
        createElement: function (name) {
            if (name === 'canvas') {
                ...
                return new lightCanvas.HTMLImageElement();
